...
import be.adamv.macroloop.collection.{VectorNArray, MatrixMNArray}
 ...
 */
def concreteMatrixImpl[M <: Int : Type, N <: Int : Type, A : Type](rowse: Expr[Tuple])(using Quotes): Expr[MatrixMNArray[M, N, A]] =
